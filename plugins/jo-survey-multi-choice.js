...
jsPsych.plugins['jo-survey-multi-choice'] = (function() {
  var plugin = {};

  plugin.info = {
    name: 'jo-survey-multi-choice',
    description: '',
    parameters: {
      questions: {
...
//        html += '<label class="jspsych-survey-multi-choice-text" for="'+input_id+'">'+question.options[j]+'</label>';
        html += '<input type="radio" name="'+input_name+'" id="'+input_id+'" value="'+question.options[j]+'" '+required_attr+'><img src='+question.options[j]+'></img></input>';
        html += '</div>';
      }
